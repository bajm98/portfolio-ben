<template>
  <footer class="body-font bottom-0 z-50 w-full bg-white text-gray-600 shadow">
    <div class="container mx-auto flex flex-col items-center px-5 py-8 sm:flex-row">
      ...
      >
        ...
        <span class="ml-3 text-xl">Benoit's Portfolio</span>
      </a>
      <p
        class="mt-4 text-sm text-gray-500 sm:ml-4 sm:mt-0 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:pl-4"
      >
        © 2025 Benoit Toussaint —
        <a href="" class="ml-1 text-gray-600" rel="noopener noreferrer" target="_blank">@bajm98</a>
      </p>
